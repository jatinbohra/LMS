 		...
 		<ul>
			...
			<li><a href="T_registration.php" style="text-decoration: none;">
 			...
 			<li><a href="T_leavelist.php" style="text-decoration: none;">
 				...
 				<span class="title">Leavelist </span>
 			</a></li>
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                <form class="form-inline">
                    <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Leave Type:</label>
                    <select class="custom-select my-1 mr-sm-2" name="inlineFormCustomSelectPref" id="inlineFormCustomSelectPref">
						...
						<option value="">Half-pay Leave </option>
						<option value="">Commuted Leave</option>
						<option value="">Extraordinary Leave</option>
